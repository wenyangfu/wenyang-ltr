## What's This?
A tutorial for improving search relevance in applcations backed by Azure Cognitive Search following the [Learning To Rank](https://en.wikipedia.org/wiki/Learning_to_rank) approach. This tutorial highlights how to use the new [featuresMode](https://docs.microsoft.com/en-us/rest/api/searchservice/2019-05-06-preview/search-documents#featuresmodedisabled--enabled-optional) capability to train a ranking model.
